...
protocol GarageChangeSearch: class {
    func toChangeGarage(_ cellView: GarageTableCell, minPark: Int, maxPark: Int) -> Void
}

class GarageTableCell: UITableViewCell, NHRangeSliderViewDelegate {
    ...
    public weak var garageChoiceDelegate: GarageChangeSearch?
    ...
    func sliderValueChanged(slider: NHRangeSlider?) {
        ...
        if let delegate = self.garageChoiceDelegate {
            delegate.toChangeGarage(self, minPark: Int(self.lowVal), maxPark: Int(self.upVal))
        }
    }
